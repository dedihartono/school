    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <img src="{{ asset('assets/templates/Mentor/assets/img/trainers/trainer-1.jpg') }}" class="img-fluid"
                        alt="">
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <img src="{{ asset('assets/templates/Mentor/assets/img/trainers/trainer-2.jpg') }}"
                        class="img-fluid" alt="">
                    <div class="member-content">
                        <h4>Sarah Jhinson</h4>
                        <span>Marketing</span>
            ...
            <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                <div class="member">
                    <img src="{{ asset('assets/templates/Mentor/assets/img/trainers/trainer-3.jpg') }}"
                        class="img-fluid" alt="">
                    <div class="member-content">
